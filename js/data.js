...
const QUESTIONS = [
  ...
  "J'ai parfois du mal à laisser les autres gérer une situation sans intervenir.",
  ...
  "Je crains parfois de ne pas être suffisamment apprécié(e) ou de ne pas répondre aux attentes de mes proches ou de mes collègues.",
  ...
  "Je préfère parfois me taire plutôt que d'exprimer mon point de vue ou mes besoins.",
  "Je ne trouve pas pleinement ma place dans certaines relations professionnelles ou au sein de mon entourage.",
  // Abandon (21-30)
  "J'ai souvent besoin d'être rassuré(e) ou encouragé(e) avant de prendre une décision importante.",
  "Je me sens parfois démuni(e) lorsque je dois faire face seul(e) à une situation difficile.",
  ...
  "Je fais souvent beaucoup d'efforts pour être aimé(e), apprécié(e) ou ne pas décevoir les autres.",
  ...
  "Je préfère parfois supporter une situation qui me fait souffrir plutôt que d'exprimer ce que je ressens ou de poser mes limites.",
